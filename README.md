💫 À propos de moi :
💫 À propos de moi :<br><br>👨‍💻 Je travaille actuellement sur :<br>- Développer un bot Tetris et des scripts CS2.<br>- Créer des projets passionnants qui mélangent ma passion pour la programmation, le développement de jeux et le design.<br>- Construire des solutions qui me poussent à dépasser mes limites et à apprendre de nouvelles technologies.<br><br>📚 Je suis en train d'apprendre :<br>- C++, C#, Python, Rust, Java<br>- Gestion de bases de données<br>- La magie de l'IA et comment elle peut être appliquée au développement de jeux.<br><br>🌱 Mon objectif :<br>- Créer des jeux et des applications qui non seulement divertissent, mais aussi inspirent les autres à apprendre et à innover.<br><br>🎉 Petit fait amusant :<br>- J'adore coder et combiner le développement de jeux avec le design graphique pour créer des projets uniques qui offrent une expérience utilisateur incroyable !<br>- Je cherche toujours des moyens de rendre la programmation plus amusante et engageante grâce à la gamification.<br>- Quand je ne code pas, vous me trouverez plongé dans les mécaniques de jeu ou en train d'expérimenter avec des designs futuristes.<br>
...
<div align="center">
  <img height="250" src="https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExbXJkbzVxNGpqNGRwcHo2N2ozeTZyZDVhaHhwaWYzNDhwMmphZDdrbCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/v2c1tTPc30szC/giphy.gif"  />
</div>
